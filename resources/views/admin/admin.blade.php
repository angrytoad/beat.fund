                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-6 col-lg-4">
                            ...
                            <a class="btn btn-primary disabled" href="{{ route('admin.users') }}">View Store Analytics</a>
                            <hr />
                        </div>
                        <div class="col-md-6 col-lg-4">
                            ...
                            <a class="btn btn-primary disabled" href="{{ route('admin.users') }}">Rights Management</a>
                            <hr />
                        </div>
                        <div class="col-md-6 col-lg-4">
                            <h4>Site Health</h4>
                        ...
                        <div class="col-md-6 col-lg-4">
                            ...
                            <a class="btn btn-primary disabled" href="{{ route('admin.users') }}">Stripe Statistics</a>
