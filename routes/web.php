...
$this->get('register-label', 'Auth\LabelRegisterController@showRegistrationForm')->name('register-label');
$this->post('register-label', 'Auth\LabelRegisterController@register');
